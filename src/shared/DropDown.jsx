...
export default function DropDown({chosenInstrucs, setChosenInstrucs}) {
  return (
    <Menu as="div" className="relative inline-block text-left">
      <div>
        <MenuButton

          className="relative btn px-6 flex items-center gap-1 py-3 border rounded-xl  bg-slate-100  text-slate-600 font-medium"
        ...
        >
          Integrate on your Website { `${chosenInstrucs ? ": "+ chosenInstrucs : ''}`}
      ...
      >
        <div className="py-1">
          <MenuItem>
            <a
            onClick={()=> setChosenInstrucs('show now')}
              href="#"
          ...
          <MenuItem>
            <a
               onClick={()=> setChosenInstrucs('mail')}
              href="#"
              className="block px-4 py-2 text-sm text-gray-700 data-focus:bg-gray-100 data-focus:text-gray-900 data-focus:outline-hidden"
            >
              A Mail
