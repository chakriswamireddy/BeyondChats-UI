	...
	return (
		...
		<div className='flex gap-0 flex-col sm:flex-row items-center justify-items-center rounded-2xl shadow-xl   w-full '>
			...
			<motion.div
				...
				className="   w-full max-w-md p-4   sm:p-8 sm:pr-8 bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800"
			>
				<div  >

					<h2 className="mb-1 sm:mb-3 text-lg sm:text-3xl font-semibold text-center">Let's Explore</h2>
					<p className="text-sm text-center text-gray-400 dark:text-gray-600">Existing user!
					...
					<div className="my-3 sm:my-6 space-y-4">
						<button aria-label="Login with Google" type="button" className="flex items-center justify-center w-full p-3 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 border-gray-400 dark:border-gray-600 focus:ring-violet-400 focus:dark:ring-violet-600">
					...
					<form noValidate="" action="" className="space-y-8">
						<div className="space-y-4">
							<div className="space-y-2">
								...
								<input type="text" name="name" onChange={(e) => setUsername(e.target.value)} id="name" placeholder="john" className="w-full px-3 py-2 border rounded-md border-gray-700 dark:border-gray-300 bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800 focus:border-violet-400 focus:dark:border-violet-600" />
							</div>
							<div className="space-y-2">
								...
								<input type="email" name="email" id="email" onChange={(e) => setUserEmail(e.target.value)}
									placeholder="john@gmail.com" className="w-full px-3 py-2 border rounded-md border-gray-700 dark:border-gray-300 bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800 focus:border-violet-400 focus:dark:border-violet-600" />
							</div>
							<div className="space-y-2">
								...
								<input onChange={(e) => setUserPwd(e.target.value)}
									...
									type="password" name="password" id="password" placeholder="*****" className="w-full px-3 py-2 border rounded-md border-gray-700 dark:border-gray-300 bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800 focus:border-violet-400 focus:dark:border-violet-600" />
							</div>
						</div>
						...
						<div className='flex justify-between'>
							...
							<button onClick={handleRegister}
								...
								type="button" className="cursor-pointer ml-auto block  w-s px-8 pr-12 py-3 font-semibold rounded-md bg-violet-400 dark:bg-violet-600 text-gray-900 dark:text-gray-50">Sign Up
