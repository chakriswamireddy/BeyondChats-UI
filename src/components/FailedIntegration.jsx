    ...
    <div>
      <section className="flex items-center h-full sm:p-16 dark:bg-gray-50 dark:text-gray-800">
        <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
          ...
          <p className="text-3xl">Looks like Some Issues are got during Integration,

          <span className=' font-semibold text-violet-500 '> Try Again </span>

          </p>

         
          <Link to='/' className="px-8 py-3 font-semibold rounded dark:bg-violet-600 dark:text-gray-50">Back to Home</Link>
        </div>
      </section>
    </div>
  )
